            ...
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        <a style="font-size: 14px; text-decoration: none;" href="index.php?controller=news&action=update&id=<?php echo $rows->id; ?>">Edit</a>&nbsp;
                        <a style="font-size: 14px; text-decoration: none;" href="index.php?controller=news&action=delete&id=<?php echo $rows->id; ?>" onclick="return window.confirm('Are you sure?');">Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </table>
