        ...
        <div class="panel-body bg-light border border-info rounded-bottom p-3">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            //có thể trực tiếp truy vấn csdl ở view
                    ...
                    <td style="text-align:center;">
                        <a style="font-size: 14px; text-decoration: none;"  href="index.php?controller=products&action=update&id=<?php echo $rows->id; ?>">Edit</a>&nbsp;
                        <a style="font-size: 14px; text-decoration: none;"  href="index.php?controller=products&action=delete&id=<?php echo $rows->id; ?>" onclick="return window.confirm('Are you sure?');">Delete</a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </table>
